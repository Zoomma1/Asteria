...
public class StarFieldFromApi : MonoBehaviour
{
    ...
    private IEnumerator LoadStarsFromApi()
    {
        ...
        using (UnityWebRequest req = UnityWebRequest.Get(url))
        {
            ...
            StarApiResponse response = JsonUtility.FromJson<StarApiResponse>(json);
            ...
            {
                Vector3 dir = EquatorialToDirection(s.raHours, s.decDeg);
                ...
                float t = Mathf.InverseLerp(maxMag, minMag, s.mag);
